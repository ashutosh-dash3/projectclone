    ...
    <main className="mx-auto max-w-7xl px-4 py-12">
      ...
      <section className="grid items-center gap-8 md:grid-cols-2">
        <div>
          ...
          <p className="mt-4 text-neutral-600 dark:text-neutral-300 max-w-prose">
            FlatBuddy helps students and young professionals find verified flats and roommates faster.
            Built with React and Tailwind CSS, it focuses on clarity, trust, and an elegant experience
      ...
      <section id="mission" className="mt-14">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[{title:'Mission',desc:'Connect people to homes with clarity and trust.'},{title:'Vision',desc:'A seamless journey from discovery to moving in.'},{title:'Values',desc:'Transparency, safety, inclusivity, and usability.'}].map((c)=> (
      ...
      <section className="mt-14">
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            {n:'Sitaram',r:'Founder & Engineer'},
            {n:'Priya',r:'Product & Research'},
            {n:'Aman',r:'Design & Brand'},
          ].map((m) => (
